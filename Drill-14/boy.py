...
class WalkingState:
    ...
    def draw(boy):
        ...
        boy.draw_x, boy.draw_y = cx, cy
        boy.font.draw(cx - 50, cy + 50, '(%5d, %5d)' % (boy.x, boy.y), (255, 255, 0))
        boy.font.draw(cx - 50, cy + 65, '(ball: %3d)' % (boy.ball_counter), (0, 0, 0))
...
class Boy:
    ...
    def __init__(self):
        ...
        self.y = 0
        self.ball_counter = 0
        self.eat_sound = load_music('pickup.wav')
